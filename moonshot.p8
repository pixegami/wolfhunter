...
function new_game_state()
  ...
  -- create enemy unit
  local enemy = new_unit("wolf", 400, {"slash", "dark charge", "strong defend", "raging strike", "ravage", "cleave"})
...
function new_attack_event(name, unit, target, value)
  ...
  event.action = function(this)
    ...
    if target.name == "wolf" and damage > target.hp and name ~= "silver knife" then
...
function draw_unit(unit, is_inverted)
  ...
  local spr_id = 1
  if unit.name == "wolf" then spr_id = 132 end
...
__gfx__

...

__sfx__
